...
private:
	...
	int comby;//y deben ser inicializadas antes de crear la combinacion, o de lo contrario se generará un error
...
void ArrPokemon::Eliminar(int posEnArreglo)
{
	...
	if (auxiliar != NULL)
	{
		...
		//...Y continuamos copiando desde el Pokemon que está despues del que se quiere eliminar hasta el final
